      ...
      <Segment>
        <Form>
          ...
          <Form.Input
            ...
            onChange={(e) => dispatch(updateFormField({ field: "firstName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Last Name"
            value={formData.lastName || ""}
            onChange={(e) => dispatch(updateFormField({ field: "lastName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Middle Name"
            value={formData.middleName || ""}
            onChange={(e) => dispatch(updateFormField({ field: "middleName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Prefered Name"
            value={formData.preferedName || ""}
            onChange={(e) => dispatch(updateFormField({ field: "preferedName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="SSN"
            value={formData.ssn || ""}
            onChange={(e) => dispatch(updateFormField({ field: "ssn", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Phone Number"
            value={formData.phone || ""}
            onChange={(e) => dispatch(updateFormField({ field: "phone", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Date of Birth"
            type="date"
            value={formData.dob || ""}
            onChange={(e) => dispatch(updateFormField({ field: "dob", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Field>
            <label>Gender</label>
            <Dropdown
              ...
              onChange={(e, { value }) => dispatch(updateFormField({ field: "gender", value }))}
              disabled={readOnly}
            />
          </Form.Field>
          <Form.Input
            ...
            onChange={(e) => dispatch(updateFormField({ field: "address", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
          label="City"
          value={formData.city || ""}
          onChange={(e) => dispatch(updateFormField({ field: "city", value: e.target.value }))}
          readOnly={readOnly}
          />
          <Form.Field>
            <label>State</label>
            <Dropdown
              ...
              onChange={(e, { value }) => dispatch(updateFormField({ field: "state", value }))}
              disabled={readOnly}
            />
          </Form.Field>
          <Form.Input
            label="Zip Code"
            value={formData.zip || ""}
            onChange={(e) => dispatch(updateFormField({ field: "zip", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Header as="h4">Reference (who referred you to this company? There can only be 1)</Header>
          <Form.Input
            label="Reference First Name"
            value={formData.referenceFirstName || ""}
            onChange={(e) => dispatch(updateFormField({ field: "referenceFirstName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Reference Middle Name"
            value={formData.referenceMiddleName || ""}
            onChange={(e) => dispatch(updateFormField({ field: "referenceMiddleName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Reference Last Name"
            value={formData.referenceLastName || ""}
            onChange={(e) => dispatch(updateFormField({ field: "referenceLastName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Reference Phone"
            value={formData.referencePhone || ""}
            onChange={(e) => dispatch(updateFormField({ field: "referencePhone", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Reference Email"
            value={formData.referenceEmail || ""}
            onChange={(e) => dispatch(updateFormField({ field: "referenceEmail", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Reference Relationship"
            value={formData.referenceRelationship || ""}
            onChange={(e) => dispatch(updateFormField({ field: "referenceRelationship", value: e.target.value }))}
            readOnly={readOnly}
          />
          ...
          <Form.Checkbox
            ...
            onChange={(e, { checked }) => {
              dispatch(updateFormField({ field: "sameAsReference", value: checked }));
              if (checked) {
                dispatch(updateFormField({ field: "emergencyFirstName", value: formData.referenceFirstName }));
                dispatch(updateFormField({ field: "emergencyMiddleName", value: formData.referenceMiddleName }));
                dispatch(updateFormField({ field: "emergencyLastName", value: formData.referenceLastName }));
                dispatch(updateFormField({ field: "emergencyPhone", value: formData.referencePhone }));
                dispatch(updateFormField({ field: "emergencyEmail", value: formData.referenceEmail }));
                dispatch(updateFormField({ field: "emergencyRelationship", value: formData.referenceRelationship }));
              }
            }}
            disabled={readOnly}
          />
          ...
          <Form.Input
            ...
            onChange={(e) => dispatch(updateFormField({ field: "emergencyFirstName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Emergency Middle Name"
            value={formData.emergencyMiddleName || ""}
            onChange={(e) => dispatch(updateFormField({ field: "emergencyMiddleName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Emergency Last Name"
            value={formData.emergencyLastName || ""}
            onChange={(e) => dispatch(updateFormField({ field: "emergencyLastName", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Emergency Phone"
            value={formData.emergencyPhone || ""}
            onChange={(e) => dispatch(updateFormField({ field: "emergencyPhone", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Emergency Email"
            value={formData.emergencyEmail || ""}
            onChange={(e) => dispatch(updateFormField({ field: "emergencyEmail", value: e.target.value }))}
            readOnly={readOnly}
          />
          <Form.Input
            label="Emergency Relationship"
            value={formData.emergencyRelationship || ""}
            onChange={(e) => dispatch(updateFormField({ field: "emergencyRelationship", value: e.target.value }))}
            readOnly={readOnly}
          />
          ...
          {formData.isPermanentResident === 'yes' && (
            <Form.Field>
              ...
              <Dropdown
                ...
                onChange={(e, { value }) => dispatch(updateFormField({ field: "greenCardStatus", value }))}
                disabled={readOnly}
              />
            </Form.Field>
          )}
            ...
            <>
              <Form.Field>
                ...
                <Dropdown
                  ...
                  onChange={(e, { value }) => dispatch(updateFormField({ field: "visaType", value }))}
                  disabled={readOnly}
                />
              </Form.Field>
              ...
              {formData.visaType === 'Other' && (
                <Form.Input
                  ...
                  onChange={(e) => dispatch(updateFormField({ field: "otherVisaTitle", value: e.target.value }))}
                  readOnly={readOnly}
                />
              )}
            </>
